...
const Port_ConfigType Port_Configuration = {
    ...
    PORT_A, PORT_A_PIN_5, PORT_PIN_OUT, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,
    PORT_A, PORT_A_PIN_6, PORT_PIN_OUT, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,
    ...
    PORT_B, PORT_B_PIN_7, PORT_PIN_OUT, PORT_MODE_0, OFF, STD_LOW, changeable, changeable,
