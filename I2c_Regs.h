...
#define I2C_MASTER_CONFIG_REG_OFFSET            (0x020) /* I2C MCR - Master Config Reg*/
#define I2C_MASTER_TIMER_PERIOD_REG_OFFSET      (0x00C) /* I2C MTPR - Master Timer Perioid Reg */
#define I2C_MASTER_SLAVE_ADDRESS_REG_OFFSET     (0x000) /* I2C MSA - Master Slave Address Reg */
